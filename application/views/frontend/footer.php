    	...
    	<div class="btn-toolbar">
			<div class="btn-group">
				<a href="javascript:agregar()" class="btn btn-default btn-lg" title='<?php echo $texto['favoritos']?>'><i class="icon-favoritefile"></i></a>
		      	...
		      	<a href="<?php echo base_url().'index.php/hoteles/como_llegar/'.$id_hotel; ?>" class="btn btn-default btn-lg" title='<?php echo $texto['direccion']?>'><i class="icon-map-marker"></i></a>
